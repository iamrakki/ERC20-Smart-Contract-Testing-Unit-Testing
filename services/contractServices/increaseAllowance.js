...
const increaseAllowanceToken = async (data) => {
    try{
    var txObject = {};
    ...
    await erc20increaseAllowanceObject(data, txObject);
    ...
    .on("receipt",async (Txreceipt) => {
        console.log("increaseAllowance conformation Completed", {
          Txreceipt : Txreceipt
        });
    })
...
const erc20increaseAllowanceObject = async (data, txObject) => {
  
    const spender = data.spender;
    const addedValue = data.addedValue;
...
module.exports={increaseAllowanceToken};